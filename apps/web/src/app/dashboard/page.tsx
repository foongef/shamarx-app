...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto flex max-w-[1400px] flex-col gap-10 pb-12 lg:gap-14">
      {/* ─── Hero ───────────────────────────────────────────────────────── */}
      <Reveal as="section" className="relative pt-2">
        <div className="pointer-events-none absolute -left-12 -top-8 -z-10 h-[420px] w-[420px] rounded-full bg-signal/[0.06] blur-[120px]" />
        <div className="grid grid-cols-12 gap-x-6 gap-y-6">
          {/* Headline */}
          <div className="col-span-12 lg:col-span-7">
            <div className="flex items-center gap-2">
              <span className="shamarx-chip">ShamarX · Cockpit · {new Date().getFullYear()}</span>
            </div>
            <h1 className="mt-4 display-serif text-[clamp(34px,5.4vw,68px)] font-semibold leading-[0.95] tracking-[0.02em]">
              The system is{' '}
              <span className="text-signal">watching</span>.
              <br />
              You&rsquo;re in command.
            </h1>
            <p className="mt-6 max-w-xl text-[14px] leading-relaxed text-muted-foreground sm:text-[15px]">
              Your ShamarX workspace bridges backtest and live execution. Arm a
              session, watch the engine evaluate sweeps in real time, drill into
              every trade, and reconcile against your broker on click.
            </p>
      ...
      <Reveal as="section" delay={0.1}>
        <div className="flex items-end justify-between gap-3 pb-5">
          <div className="flex flex-col gap-1">
            <span className="shamarx-chip">02 / Strategies</span>
            <h2 className="display-serif text-[24px] leading-tight tracking-[0.04em] sm:text-[28px]">
      ...
      <Reveal as="section" delay={0.15}>
        <div className="flex items-end justify-between gap-3 pb-5">
          <div className="flex flex-col gap-1">
            <span className="shamarx-chip">03 / Backtests</span>
            <h2 className="display-serif text-[24px] leading-tight tracking-[0.04em] sm:text-[28px]">
              Recent runs.
            </h2>
            <p className="font-mono text-[11px] tracking-wide text-muted-foreground">
          ...
          {!isLoading && runs.length === 0 && (
            <div className="flex flex-col items-center gap-3 px-4 py-12 text-center">
              ...
              <p className="max-w-md text-[13px] text-muted-foreground">
                Spin up a backtest to mark a strategy against the engine, trade-by-trade.
              </p>
              <Link
                href="/backtest/new"

...
// V6: Strategy version selector. 'GIDEON' is the current canonical name;
// 'V6-alt' is kept as a legacy alias so existing DB rows + scripts still
// type-check. New writes should use 'GIDEON'. ('SMC-V2' and 'V6-alt'
// remain accepted for rows persisted before the renames.)
export type StrategyVersion = 'V5.5b' | 'V6' | 'V6-alt' | 'SMC-V2' | 'GIDEON';
...
export function isSmcV2(v: string | null | undefined): boolean {
  return v === 'GIDEON' || v === 'SMC-V2' || v === 'V6-alt';
}
